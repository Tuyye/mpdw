...
```{r}
data <- rio::import("https://raw.githubusercontent.com/Tuyye/mpdw/main/Tugas/DataTugas3/Data%20CO2%20Indonesiaa.csv")
str(data)
data
```
...
```{r}
fore.koyck <- forecast(model = model.koyck, x=test$SolidFuel, h=25)
fore.koyck
...
points(test$SolidFuel, fore.koyck$forecasts,col="red")
lines(test$SolidFuel, fore.koyck$forecasts,col="red")
